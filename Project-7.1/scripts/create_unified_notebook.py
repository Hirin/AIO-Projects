...
def create_notebook():
    ...
    # Data Distribution Visualization (always run)
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
    ...
    # Balanced Data Distribution (only if USE_DATA_BALANCE)
    cells.append({
        "cell_type": "code",
        "execution_count": None,
        "metadata": {},
...
if __name__ == "__main__":
    ...
    output_path = "/mnt/hdd/Learning/AIO-Projects/Project-7.1/notebooks/unified-ablation.ipynb"
