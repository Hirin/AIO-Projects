"""
Generate videoMAE-RandAugment.ipynb for Option A testing
"""
import json
...
# Install
add_code("!pip install -q transformers accelerate evaluate gdown")
...
# VideoRandAugment class
add_markdown("## 2. VideoRandAugment Class")
add_code([
...
# Training functions
add_markdown("## 5. Training & Evaluation Functions")
add_code([
...
# Plot curves
add_markdown("##7. Plot Training Curves")
add_code([
...
# Save notebook
output_path = "/mnt/hdd/Learning/AIO-Projects/Project-7.1/videoMAE-RandAugment.ipynb"
with open(output_path, 'w') as f:
    json.dump(nb, f, indent=2)

print(f"✅ Created: {output_path}")
print("\nNotebook includes:")
print("  - VideoRandAugment class (consistent augmentation)")
print("  - 2-Stage training: RandAugment → Label Smoothing")
print("  - Standard Cross Entropy (no Mixup/Focal Loss)")
print("  - Training curves with baseline comparison")
print("\nTarget: ≥ 85% Test Accuracy")
